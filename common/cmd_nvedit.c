...
int do_resetenv(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
	extern char * env_name_spec;

	printf ("Erasing Environment of %s...\n", env_name_spec);
...
U_BOOT_CMD(
	resetenv, 1, 0,	do_resetenv,
	"resetenv- erase environment variables\n",
	NULL
);
#endif
#endif	/* CFG_CMD_ENV */
