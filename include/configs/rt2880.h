...
#define CONFIG_ETHADDR              "00:03:14:15:92:65"
/* valid baudrates */
...
/** Add By JINWEI @2015.8.27 */
/* 
 * Product Encrypt information and Hardware version information
 * share the same SPI flash block(0x10000 = 64KB). 
 * Hardware version information starts at 0x48000 
 */
#define CONFIG_FACTORY_OFFSET       0x40000
#define CONFIG_EEPROM_OFFSET        CONFIG_FACTORY_OFFSET 
#define CONFIG_EEPROM_SIZE          0x8000

#define CONFIG_HVER_OFFSET          (CONFIG_EEPROM_OFFSET + CONFIG_EEPROM_SIZE)
#define CONFIG_HVER_SIZE            0x4000

#define CONFIG_BOOTPARAMS_OFFSET    (CONFIG_HVER_OFFSET + CONFIG_HVER_SIZE)
#define CONFIG_BOOTPARAMS_SIZE      0x4000
/* 
 * for TEST 
 */
